    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-brand-lavender-light/20 p-6">
        ...
        <div className="bg-brand-lavender-light/5 rounded-lg p-4">
          ...
          <div className="w-full bg-brand-lavender-light/20 rounded-full h-2 mb-4">
            <div
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="bg-white rounded-lg border border-brand-lavender-light/30 p-4 hover:shadow-md transition-all">
              <div className="flex items-center gap-3 mb-2">
